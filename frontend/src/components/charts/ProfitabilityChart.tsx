...
export default function ProfitabilityChart({ assets }: ProfitabilityChartProps) {
  ...
  return (
    <ResponsiveContainer width="100%" height={200}>
      <PieChart>
        <Pie data={data} dataKey="value" cx="50%" cy="50%" outerRadius={75} innerRadius={35} paddingAngle={3}>
