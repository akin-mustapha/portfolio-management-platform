...
>>>>>>> 74aff6ca946f0bd151cffbd68dda9e801cfa3223
  ...
  bgCard: '#ffffff',
  bgCardBorder: '#eef0f3',
  bgRowHover: 'rgba(59, 91, 255, 0.04)',
  bgRowSelected: 'rgba(59, 91, 255, 0.08)',
  bgZebra: 'rgba(0, 0, 0, 0.015)',
  textPrimary: '#0b1120',
  textSecondary: '#5b6576',
  shadowCard: '0 1px 3px rgba(16, 24, 40, 0.04), 0 1px 2px rgba(16, 24, 40, 0.02)',
  shadowCardHover: '0 4px 20px rgba(16, 24, 40, 0.06), 0 2px 4px rgba(16, 24, 40, 0.04)',
}
...
=======
  ...
  bgCard: '#111214',
  bgCardBorder: '#1e2024',
  bgRowHover: 'rgba(107, 140, 255, 0.06)',
  bgRowSelected: 'rgba(107, 140, 255, 0.12)',
