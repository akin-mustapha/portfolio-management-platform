export const metricDefinitions = {
  ...
  daily_value_return: {
    title: "Daily Return",
    definition:
      "How much the asset's price moved today, expressed as a percentage.",
    interpret:
  ...
  weight_pct: {
    title: "Weight %",
    definition:
      "This position's share of your total portfolio value as a percentage.",
    interpret:
  ...
  recent_profit_high_30d: {
    title: "30D High",
    definition:
      "The highest unrealised profit value this position reached over the last 30 days.",
    interpret:
  ...
  daily_change_pct: {
    title: "Daily Change %",
    definition:
      "The total portfolio's percentage change in value over the current trading day.",
    interpret:
