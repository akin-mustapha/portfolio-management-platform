  ...
  return (
    <div>
      <Section title="Portfolio Value & P&L" metricKey="portfolio_value_chart">
        <PortfolioValueChart
          valueSeries={
            data.portfolio_value_series as Parameters<
              typeof PortfolioValueChart
            >[0]["valueSeries"]
          }
          pnlSeries={
            data.portfolio_pnl_series as Parameters<
              typeof PortfolioValueChart
            >[0]["pnlSeries"]
          }
        />
        ...
        >
          ...
          >
            <Section
              ...
              metricKey="position_weight_chart"
              sx={{ flex: 1, mb: 0 }}
            >
              <PositionWeightChart
                distribution={
                  data.position_distribution as Parameters<
                    typeof PositionWeightChart
                  >[0]["distribution"]
                }
              />
            </Section>
          ...
          >
            <Section title="Daily Movers" sx={{ flex: 1, mb: 0 }}>
              <DailyMoversTable
                movers={
                  data.daily_movers as Parameters<
                    typeof DailyMoversTable
                  >[0]["movers"]
                }
              />
            </Section>
      ...
      <Section title="Winners & Losers">
        <Grid container spacing={1}>
          <Grid size={{ xs: 12, md: 6 }}>
            ...
            <WinnersChart
              winners={
                data.winners as Parameters<typeof WinnersChart>[0]["winners"]
              }
            />
          </Grid>
          <Grid size={{ xs: 12, md: 6 }}>
            ...
            <LosersChart
              losers={
                data.losers as Parameters<typeof LosersChart>[0]["losers"]
              }
            />
          </Grid>
        </Grid>
