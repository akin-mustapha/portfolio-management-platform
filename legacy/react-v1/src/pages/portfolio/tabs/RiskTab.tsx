  ...
  return (
    <div>
      <Section title="Portfolio Drawdown" metricKey="portfolio_drawdown_chart">
        <DrawdownChart
          drawdown={
            data.portfolio_drawdown as Parameters<
              typeof DrawdownChart
            >[0]["drawdown"]
          }
        />
      </Section>
      ...
      <Section
        ...
        metricKey="position_profitability_chart"
      >
        <ProfitabilityChart
          assets={
            data.profitability as Parameters<
              typeof ProfitabilityChart
            >[0]["assets"]
          }
        />
      </Section>
      ...
      <Section title="VaR by Position" metricKey="var_by_position_chart">
        <VarByPositionChart
          varData={
            data.var_by_position as Parameters<
              typeof VarByPositionChart
            >[0]["varData"]
          }
        />
      </Section>
      ...
      <Section title="Unprofitable Positions P&L">
        <UnprofitablePnlChart
          losersData={
            data.losers_pnl as Parameters<
              typeof UnprofitablePnlChart
            >[0]["losersData"]
          }
        />
      </Section>
