...
class Trading212AssetSourceGold(Source):
  def __init__(self):
...
class Trading212AssetTransformationGold(Transformation):
  """
    Trading212AssetTransformationGold
  """
...
class PipelineAssetGold(Pipeline):
  def __init__(self):
    self._source = Trading212AssetSourceGold()
    self._transformation = Trading212AssetTransformationGold()
