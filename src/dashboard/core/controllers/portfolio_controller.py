...
class PortfolioController:
    ...
    def get_data(self):
        ...
        try:
            ...
            asset_data_history = self._query_factory.get("asset_query").get_asset_history()
            ...
            price_history = self._query_factory.get("asset_query").get_portfolio_price_history(tickers)
