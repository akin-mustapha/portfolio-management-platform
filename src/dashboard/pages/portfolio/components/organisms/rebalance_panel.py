        ...
        [
            ...
            html.Div(
                [
                    html.Span(
                        [
                            html.I(className="fa-solid fa-scale-balanced me-2"),
                            "Rebalancing",
                        ],
            ...
            html.Small(
                "",
                id="rebalance-panel-status",
                className="text-muted rebalance-status-text",
            ),
            html.Hr(className="tv-divider"),
            ...
            html.Div(
                [
                    ...
                    _slider_row(
                        "Target Weight %",
                        {
                            "type": "rebalance-slider",
                            "index": f"{ticker}|target_weight_pct",
                        },
                        0,
                        50,
                        1,
                        cfg.get("target_weight_pct", 5),
                    ),
                    _slider_row(
                        "Drift Threshold %",
                        {
                            "type": "rebalance-slider",
                            "index": f"{ticker}|rebalance_threshold_pct",
                        },
                        0,
                        20,
                        1,
                        cfg.get("rebalance_threshold_pct", 2.0),
                    ),
                    _slider_row(
                        "Tolerance Band %",
                        {
                            "type": "rebalance-slider",
                            "index": f"{ticker}|tolerance_band_pct",
                        },
                        0,
                        25,
                        1,
                        cfg.get("tolerance_band_pct", 5),
                    ),
                    _slider_row(
                        "Correction Days",
                        {
                            "type": "rebalance-slider",
                            "index": f"{ticker}|correction_days",
                        },
                        1,
                        30,
                        1,
                        cfg.get("correction_days", 7),
