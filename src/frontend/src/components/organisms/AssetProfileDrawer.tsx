...
export default function AssetProfileDrawer({ open, onClose }: AssetProfileDrawerProps) {
    ...
    >
      ...
      >
        <Box sx={{
          ...
          <Typography
            variant="caption"
            sx={{ textTransform: 'uppercase', letterSpacing: 1, fontWeight: 700, color: 'text.secondary', fontSize: 10.5 }}
          >
            Asset Profile
          </Typography>
          <IconButton
            size="small"
            onClick={onClose}
            sx={{ transition: 'transform 160ms ease, color 160ms ease', '&:hover': { color: 'text.primary' } }}
          >
