...
export default function PositionWeightChart({
  top10,
}: PositionWeightChartProps) {
  ...
  function CustomTooltip({
    ...
    const d = (payload as Array<{ payload: PositionWeightTop10Item }>)[0]
      .payload;
    return (
      <div
        style={{
      ...
      >
        ...
        <div style={{ color: textSecondary, fontSize: 10, marginBottom: 2 }}>
          {d.name}
        </div>
