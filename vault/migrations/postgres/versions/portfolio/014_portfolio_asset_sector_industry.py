...
down_revision: str | None = "4400000000dd"
...
_CLASSIFICATIONS = [
    ...
    (
        "AAPL",
        "ca24df5e-e5c8-4fec-9599-30f874dd73d1",
        "380dcb63-79ff-4add-bbd8-513a7a4f0a83",
    ),
    (
        "SMCI",
        "ca24df5e-e5c8-4fec-9599-30f874dd73d1",
    ...
    (
        "MSFT",
        "77941094-60d6-4d99-bb9d-b80f9b9847e9",
        "380dcb63-79ff-4add-bbd8-513a7a4f0a83",
    ),
    (
        "ADBE",
    ...
    (
        "NVDd",
        "f06bc951-e640-4165-9c22-061035c1f456",
        "380dcb63-79ff-4add-bbd8-513a7a4f0a83",
    ),
    (
        "AMDd",
    ...
    (
        "AMZN",
        "aeba4050-064e-4f6d-b1a8-6bf53b8c8187",
        "380dcb63-79ff-4add-bbd8-513a7a4f0a83",
    ),
    # Communication Services / Internet & Media
    (
        "GOOGL",
        "6981f0de-0b0d-43b3-b326-5359df7cd93c",
        "249142d8-8900-475f-9b57-f15fd4640a3f",
    ),
    (
        "FB",
        "6981f0de-0b0d-43b3-b326-5359df7cd93c",
    ...
    (
        "EA",
        "6725bde5-3dba-4c09-8713-6b3cf39edb62",
        "249142d8-8900-475f-9b57-f15fd4640a3f",
    ),
    (
        "SNE",
    ...
    (
        "TSLA",
        "b7e27cf1-81fc-401a-8544-c8c00c18ff96",
        "3305e7e2-4fa6-45bd-b362-3366df9be7f8",
    ),
    # Consumer Discretionary / Retail
    (
        "NKE",
        "03b43466-baf9-463c-a28d-6c8537f4ef7e",
        "3305e7e2-4fa6-45bd-b362-3366df9be7f8",
    ),
    # Consumer Staples / Food & Beverages
    (
        "KO",
        "19ba0016-21b7-42bb-8184-99c06422a091",
        "dab50a95-885c-4736-b06b-f02bc1e95e18",
    ),
    # Consumer Staples / Household Products
    (
        "BMT1d",
        "de88e860-16eb-4ced-8f62-874a94a90162",
        "dab50a95-885c-4736-b06b-f02bc1e95e18",
    ),
    # Healthcare / Pharmaceuticals
    (
        "PFE",
        "2f35a427-7995-4e84-9f7c-9a0f8d1fb945",
        "0e24e223-7784-41c9-88a4-48b945660114",
    ),
    # Healthcare / Healthcare Services
    (
        "UNH",
        "7a8561f7-230d-45fe-982c-638e6ebd4d15",
        "0e24e223-7784-41c9-88a4-48b945660114",
    ),
    # Financials / Insurance
    (
        "ALVd",
        "7818efd6-fb3d-40ea-a5d0-48386c6ad9e6",
        "2acea78b-ccb4-40ed-98cf-860d35741660",
    ),
    (
        "SFGYY",
        "7818efd6-fb3d-40ea-a5d0-48386c6ad9e6",
    ...
    (
        "CHVd",
        "2b80a561-c81a-414a-a3a7-c04a063fb672",
        "f180fc82-968e-42f3-8c97-6fb9a4431c5d",
    ),
    (
        "SHELl",
        "2b80a561-c81a-414a-a3a7-c04a063fb672",
    ...
    (
        "AIRp",
        "05de02aa-72a7-4c25-8cc5-995b9990a974",
        "79767d45-a23b-4085-b1d1-1dacbd79cd8a",
    ),
]
