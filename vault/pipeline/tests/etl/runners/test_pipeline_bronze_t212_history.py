...
class TestSourcePagination:
    def _build_source(self, paginated_factory, stored_ts=None):
        from pipeline.etl.runners.pipeline_bronze_t212_history import (
...
class TestLoader:
    def _build_loader(self):
        ...
        with patch("pipeline.etl.loaders.loader_bronze_t212_history.SQLModelClient") as mock_client_cls:
